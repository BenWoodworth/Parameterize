...
/**
 * Runs the [block] for each combination of arguments, as declared with the [parameter][ParameterizeScope.parameter]
 * functions:
 *
 * ```
 * parameterize {
...
/**
 * Calls [parameterize] with the given [configuration], but with the provided options overridden.
 *
