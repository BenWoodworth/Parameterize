...
public class ParameterizeConfiguration internal constructor(
    ...
    public class Builder internal constructor(from: ParameterizeConfiguration?) {
         ...
         *
         * The provided `iteration` function must be invoked exactly once, and will return without throwing even if the
         * iteration fails. This guarantees that any post-iteration cleanup will always be executed.
         *
         ...
         */
        public var decorator: suspend DecoratorScope.(iteration: suspend DecoratorScope.() -> Unit) -> Unit = from?.decorator
            ?: { iteration ->
                iteration()
            }
         ...
         *
         * **Note:** The default [onFailure] handler prevents [onComplete] from executing, immediately throwing instead
         * of continuing and tracking failures to be handled here.
         *
         * Defaults to:
         * ```
         * onComplete = {
