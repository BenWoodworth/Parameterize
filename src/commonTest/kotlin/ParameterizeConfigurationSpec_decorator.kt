...
class ParameterizeConfigurationSpec_decorator {
    private inline fun testParameterize(
        ...
        noinline onFailure: (OnFailureScope.(failure: Throwable) -> Unit)? = null,
        noinline onComplete: (OnCompleteScope.() -> Unit)? = null,
        ...
        parameterize(
            ...
            onComplete = onComplete ?: ParameterizeConfiguration.default.onComplete,
            block = block
        )
