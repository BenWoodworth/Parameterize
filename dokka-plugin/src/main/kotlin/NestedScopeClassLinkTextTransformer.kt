...
/**
 * Shortens link text for nested scope classes by removing preceding outer class names.
 *
 * For example:
 * ```
 * // Before
...
class NestedScopeClassLinkTextTransformer(
    ...
    private fun recursivelyTrimOuterClassPrecedingScopeInLinkText(contentNode: ContentNode): ContentNode =
        when {
            TextStyle.Paragraph in contentNode.style -> contentNode // Don't trim KDoc Markdown links
